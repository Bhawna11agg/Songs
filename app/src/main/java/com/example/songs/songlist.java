...
public class songlist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (types == R.id.btn1)
            recyclerView1.setAdapter(new Adapter2(lang1));
        if (types == R.id.btn2)
            recyclerView1.setAdapter(new Adapter2(lang2));
        if (types == R.id.btn3)
            recyclerView1.setAdapter(new Adapter2(lang3));
        if (types == R.id.btn4)
            recyclerView1.setAdapter(new Adapter2(lang4));
        if (types == R.id.btn5)
            recyclerView1.setAdapter(new Adapter2(lang5));
        if (types == R.id.btn6)
            recyclerView1.setAdapter(new Adapter2(lang6));
